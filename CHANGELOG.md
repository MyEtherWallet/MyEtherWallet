...
* * replace settings address table component with new table\* replace dashboard token table with new table component
    [#4249](https://github.com/MyEtherWallet/MyEtherWallet/pull/4249)
