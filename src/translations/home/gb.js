const home = {
  ...
  obtainAddress:
    'To obtain ETH address and generate your private key. Saving and safekeeping the key will be your responsibility.',
  getStarted: 'Get Started',
  accessMyWalletDesc:
    'To send Ethereum and tokens, swap coins, sale the domain, deploy the contract after you access your wallet.',
  ...
  aboutMewWalletDesc:
    'Text here for feature description, Text here for feature description, Text here for feature description, Text here for feature description, Text here for feature description.',
