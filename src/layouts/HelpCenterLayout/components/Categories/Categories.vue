  ...
  <div class="categories">
    <div class="wrap">
      ...
      <ul class="category-buttons">
        <li v-for="button in categoryButtons" v-bind:key="button.key"><category-button :content="button" /></li>
      </ul>

      <div class="link-blocks">
        <link-block v-for="block in linkBlocks" v-bind:key="block.key" :content="block" />
      </div>
...
import iconGithub from '@/assets/images/HelpCenter/github.svg'
      ...
      linkBlocks: [
        {
          ...
          description: 'Can\'t find your answer? Get in touch and we\'ll get back as soon as we can.',
          email: 'support@myetherwallet.com'
        },
        {
          icon: iconCommunity,
          title: 'Community',
          description: 'Join our MEW community, and get more information from us.',
          social: [
