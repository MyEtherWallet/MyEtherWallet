    ...
    <div class="wrap">
      ...
      <div class="qa-cards">
        <ul class="qa__contents">
          ...
          <li>
            <div v-on:click="openFAQ('faq6')" class="qa__contents--title">
          ...
          <li>
            <div v-on:click="openFAQ('faq7')" class="qa__contents--title">
              ...
              <div class="show-more-buttons">
                ...
                <span v-if="showFAQs.faq7 == true" class="show-less">-</span>
              </div>
            </div>
          ...
          <li>
            <div v-on:click="openFAQ('faq8')" class="qa__contents--title">
          ...
          <li>
            <div v-on:click="openFAQ('faq9')" class="qa__contents--title">
          ...
          <li>
            <div v-on:click="openFAQ('faq10')" class="qa__contents--title">
          ...
          <li>
            <div v-on:click="openFAQ('faq11')" class="qa__contents--title">
          ...
          <li>
            <div v-on:click="openFAQ('faq12')" class="qa__contents--title">
          ...
          <li>
            <div v-on:click="openFAQ('faq13')" class="qa__contents--title">
