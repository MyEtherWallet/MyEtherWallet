  ...
  methods: {
    ...
    async fetchTokens() {
      if (this.network.type.name === "ETH") {
        ...
        const data = `0x80f4ae5c000000000000000000000000${this.$store.state.wallet
          .getAddress()
          .toString(
            "hex"
          )}`;
    ...
    async getTokenBalance(address) {
      ...
      return web3.eth
        ...
        .then(res => unit.fromWei(web3.utils.toBN(res).toString(), "ether"))
