const statusTypes = {
  new: { text: 'notifications.swap-created', class: 'status-processing' },
  sent: { text: 'notifications.processing', class: 'status-processing' },
  pending: { text: 'notifications.processing', class: 'status-processing' },
  complete: { text: 'notifications.success', class: 'status-succeed' },
  failed: { text: 'notifications.failed', class: 'status-failed' },
  cancelled: { text: 'notifications.cancelled', class: 'status-processing' },
  error: { text: 'notifications.error', class: 'status-failed' },
  statusError: { text: 'notifications.status-error', class: 'status-failed' }
};
