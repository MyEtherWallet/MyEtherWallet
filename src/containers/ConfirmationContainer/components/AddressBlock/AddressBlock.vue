<template lang="html">
  <div class="address-container">
    ...
    <div class="address" @click="doubleCheckLink(checksumAddress)">{{ checksumAddress }}</div>
    <div v-if="tokenSymbol !== '' && direction === 'to'">
      <p>{{ $t('sendTx.via-contract') }}</p>
      <div class="address" @click="doubleCheckLink(tokenChecksumAddress)">{{ tokenChecksumAddress }}</div>
    </div>
  </div>
</template>
