const ChangellyCurrencies = {
  ...
  BUSD: { symbol: 'BUSD', name: 'Binance USD (BUSD)', fixRateEnabled: false },
  ...
  NANO: { symbol: 'NANO', name: 'Nano (NANO)', fixRateEnabled: true },
