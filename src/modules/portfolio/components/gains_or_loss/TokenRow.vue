      ...
      <div class="grid grid-cols-4 w-full items-center justify-between gap-2">
        ...
        <div class="col-span-1 flex flex-col items-start">
          ...
          <div
            ...
            :class="{
              'text-text-error': token.percentChange < 0,
              'text-text-success': token.percentChange >= 0,
            }"
          >
            <span
        ...
        >
          <p
            ...
            :class="{
              'text-text-error': token.gainOrLoss.isLessThan(0),
              'text-text-success': token.gainOrLoss.isGreaterThan(0),
            }"
          >
