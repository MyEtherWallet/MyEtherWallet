<template>
  <div
    class="flex flex-col justify-between gap-4 rounded-2xl border border-border-default bg-white px-5 py-5 xs:px-6 xs:py-6 w-full relative"
  >
    <div class="flex flex-col gap-1">
      <p class="text-s-20 font-bold text-black">{{ t('rewards.get_ready') }}</p>
      <h2
        class="text-s-32 xs:text-s-26 font-bold leading-p-110 text-text-brand"
      >
