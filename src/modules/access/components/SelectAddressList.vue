    ...
    <div v-for="i in 5" :key="i">
      <button
        ...
        :class="[
          ...
          'flex px-2 xs:px-4 py-2 items-center gap-2 xs:gap-5 w-full rounded-2xl  min-h-12',
        ]"
        @click="model = walletList[i - 1].index"
        v-ripple
      >
        <div class="text-xs text-info min-w-5">
        ...
        <div class="text-start">
          <div class="flex items-center">
            <p>{{ truncateAddress(walletList[i - 1].address, 7) }}</p>
            <app-btn-copy
            ...
            <app-btn-icon
              ...
              class="text-primary ml-3 xs:ml-0"
              @click.stop
            >
