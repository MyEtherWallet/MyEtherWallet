    ...
    >
      <app-sheet>
        ...
        <div class="flex items-center justify-center">
          ...
          <div
            v-show="isLoading"
            class="h-[200px] w-[200px] sm:h-[280px] sm:w-[280px] flex items-center justify-center bg-background-default rounded-xl mt-5"
          >
            <svg
              aria-hidden="true"
        ...
        <a
          class="text-text-subtle text-center text-xs mx-auto block"
