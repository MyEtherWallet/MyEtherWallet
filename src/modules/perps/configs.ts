...
const perpsClient = new PerpsClient(
  configs.PERPS_ENV === 'live' ? PERPS_BASE_URL.live.url : PERPS_BASE_URL.sandbox.url,
)

const perpsWsUrl = configs.PERPS_ENV === 'live' ? PERPS_WS_URL.live : PERPS_WS_URL.sandbox
