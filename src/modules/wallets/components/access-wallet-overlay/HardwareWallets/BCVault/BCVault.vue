    ...
    >
      <template #mewOverlayBody>
        <div v-if="step === 1" class="full-width">
          <h2 class="text-center mb-10">1. Enter your global password</h2>
          <mew6-white-sheet max-width="600px" class="mx-auto pa-4 pa-sm-12">
            <div class="mb-3 font-weight-bold">
              Please enter the global password of your BC Vault device.
            </div>
            <div class="mb-6">
              Notice: You need to also enter a pin number on your BC Vault
              device.
            </div>
        ...
        <div v-if="step === 2" class="full-width">
          <h2 class="text-center mb-10">2. Connect with BC Vault</h2>
          <mew6-white-sheet max-width="600px" class="mx-auto pa-4 pa-sm-12">
