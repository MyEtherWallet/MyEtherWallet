    ...
    >
      <template v-slot:mewOverlayBody>
        <div v-if="step === 1" class="full-width">
          <h2 class="text-center mb-10">1. Enter your pairing password</h2>
          <mew6-white-sheet max-width="600px" class="mx-auto pa-4 pa-sm-12">
            <div class="mb-6 font-weight-bold">
              Please enter the pairing password of your CoolWallet device.
            </div>
            <v-text-field
              label="Password"
              :type="showPassword ? 'text' : 'password'"
              placeholder="Enter your pairing password"
              outlined
        ...
        <div v-if="step === 2" class="full-width">
          <h2 class="text-center mb-10">2. Connect with CoolWallet</h2>
          <mew6-white-sheet max-width="500px" class="mx-auto pa-4 pa-sm-12">
            ...
            <div class="d-flex align-center justify-space-between mb-3">
              <div>App opened in CoolWallet</div>
              <div class="font-weight-bold">Ethereum</div>
            </div>

            <div class="d-flex align-center justify-space-between mb-10">
              <div>HD derivation path</div>
              <div class="font-weight-bold">m/44'/60'/0'</div>
            </div>

            <div class="d-flex justify-center mt-2">
              <mew-button
                title="Connect with CoolWallet"
                button-size="xlarge"
                :has-full-width="false"
                @click.native="step += 1"
              />
