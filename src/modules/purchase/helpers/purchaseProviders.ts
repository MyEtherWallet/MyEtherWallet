...
import cashappLogo from '@/assets/images/buy/icon-cash-app-logo.png'
...
const CASH_APP: PaymentMethodIcon = { src: cashappLogo, alt: 'Cash App' }
...
export const getPaymentMethodIcons = (
  ...
  if (has('CASH_APP')) icons.push(CASH_APP)
