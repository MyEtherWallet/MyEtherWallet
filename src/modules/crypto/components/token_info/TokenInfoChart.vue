...
const chartFilterOptions = ref<Item[]>([
  { label: t('crypto.chart_1d'), value: '1D' },
  { label: t('crypto.chart_7d'), value: '7D' },
  { label: t('crypto.chart_1m'), value: '1M' },
  { label: t('crypto.chart_3m'), value: '3M' },
  { label: t('crypto.chart_1y'), value: '1Y' },
  { label: t('crypto.chart_all'), value: 'ALL' },
])
