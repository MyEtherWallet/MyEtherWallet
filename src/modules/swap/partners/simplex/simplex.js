...
import SimplexApi from './simplex-api';
...
export default class Simplex {
  ...
  static async getOrderStatus(errorHandler, noticeDetails) {
    const result = await new SimplexApi(errorHandler).getStatus(
