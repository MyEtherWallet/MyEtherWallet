...
<script>
import { toBN, toWei, isAddress } from 'web3-utils';
import {
  // debounce,
  isEmpty,
  clone,
...
export default {
  ...
  methods: {
    ...
    //       this.setToLocalContractToToken(Object.assign({}, token, foundToken));
    //       return;
    //     }
    ...
    //       foundToken.value = foundToken.contract;
    //       foundToken.subtext = name;
    //       this.setToLocalContractToToken(foundToken);
    //       return;
    //     }
    //     token.price = '';
    ...
    //     this.setToLocalContractToToken(token);
    //   });
    // },
    /**
     * Add token to localContractToToken
     */
    // setToLocalContractToToken(token) {
    ...
    setupBridge() {
      if (this.isAvailable) {
        ...
        //     });
        // } else {
        //   this.processTokens(this.bridgeTokens, false);
        //   this.isLoading = false;
        // }
