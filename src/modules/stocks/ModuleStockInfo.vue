<template>
  <div class="flex flex-col mb-10 w-full divide-y divide-border-default">
    ...
    >
      <div
        class="h-[308px] xs:h-[227px] animate-pulse bg-background-default-hover rounded-12 w-full"
      ></div>
    </div>
  </div>
</template>
