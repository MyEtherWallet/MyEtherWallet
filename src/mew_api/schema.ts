...
export interface paths {
    ...
    "/v1/web/pages/stocks/oips": {
        ...
        get: operations["GetWebStocksOips"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/v1/web/pages/stocks-info/stocks/{symbol}/description": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        get: operations["GetWebStocksInfoDescription"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/v1/web/pages/token-info/coins/{coin}/description": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        get: operations["GetWebTokenInfoPageDescriptionByCoin"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/v1/web/chains/{chainName}/addresses/{address}/token-balances": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        get: operations["GetWebBalancesByChainNameAndAddress"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
...
export interface components {
    schemas: {
        ...
        /** @description A chain on which this coin exists as a contract. */
        CoinChain: {
            chainName: string;
            ...
            chainIconUrl: string;
            contract: string;
            /** @description Null when the token's decimals are not known. Never defaulted -- treat null as unknown rather than assuming 18. */
            decimals: number | null;
        };
        /** @description A chain on which this coin is the native currency. There is deliberately no `contract` -- the coin is not a contract on this chain. */
        CoinNativeChain: {
            chainName: string;
            chainNameLong: string;
            chainType: components["schemas"]["ChainType"];
        ...
        /** @description A chain on which an Ondo tokenized asset is deployed. Always a contract -- a tokenized asset is never a chain's native currency. */
        OndoChain: {
            chainName: string;
            chainNameLong: string;
            chainType: components["schemas"]["ChainType"];
        ...
        GetWebStocksOverviewResponse: {
            newlyAdded: {
                /** @description Description of this tokenized asset or the stock underlying it, pre-generated by the scraping jobs. Null when it has not been generated yet, or no source has one. Plain text. No markup. English only. */
                description: null | string;
                /** @description Where `description` came from. Null whenever `description` is null. */
                descriptionSource: null | components["schemas"]["DescriptionSource"];
                stockAlias?: string;
                iconPngUrl?: string;
                iconSvgUrl?: string;
                primaryMarket: {
        ...
        GetWebStocksOipsResponse: {
            ...
            /** @enum {string} */
            category: "Thematic" | "Income" | "Allocation";
            /** @enum {string} */
            modelProvider: "Ondo" | "BlackRock";
        ...
        GetWebStocksInfoDescriptionResponse: {
            /** @description Description of this tokenized asset or the stock underlying it, depending on which source had one. Null when unavailable -- the asset is unknown, no source has a description for it, or the lookup failed. Plain text. No markup. English only. */
            description: null | string;
            /** @description Where `description` came from. Null whenever `description` is null. */
            descriptionSource: null | components["schemas"]["DescriptionSource"];
        };
        ...
        GetWebTokenInfoPageDescriptionResponse: {
            /** @description Description of the coin. Null when unavailable -- the coin is unknown, no source has a description for it, or the lookup failed. Plain text. No markup. English only. */
            description: null | string;
            /** @description Where `description` came from. Null whenever `description` is null. */
            descriptionSource: null | components["schemas"]["DescriptionSource"];
        };
        ...
        GetWebCryptoOverviewResponse: {
            ...
            newCoins: {
                /** @description Description of the coin, pre-generated by the scraping jobs. Null when it has not been generated yet, or the upstream provider has none. Plain text. No markup. English only. */
                description: null | string;
                /** @description Where `description` came from. Null whenever `description` is null. */
                descriptionSource: null | components["schemas"]["DescriptionSource"];
                coinId: string;
                ...
                chains: components["schemas"]["CoinChain"][];
                nativeChains: components["schemas"]["CoinNativeChain"][];
            }[];
            ondoTopGainers: {
                stockAlias?: string;
                iconPngUrl?: string;
        ...
        GetWebBalancesByChainNameAndAddressResponse: {
            result: {
                coinId?: string;
                balance: string;
                contract: string;
    ...
    responses: {
        ...
        GetWebStocksOipsSuccess: {
            headers: {
                [name: string]: unknown;
            };
            content: {
                "application/json": components["schemas"]["GetWebStocksOipsResponse"];
            };
        };
        ...
        GetWebStocksInfoDescriptionSuccess: {
            headers: {
                [name: string]: unknown;
            };
            content: {
                "application/json": components["schemas"]["GetWebStocksInfoDescriptionResponse"];
            };
        };
        ...
        GetWebTokenInfoPageDescriptionSuccess: {
            headers: {
                [name: string]: unknown;
            };
            content: {
                "application/json": components["schemas"]["GetWebTokenInfoPageDescriptionResponse"];
            };
        };
        ...
        GetWebBalancesByChainNameAndAddressSuccess: {
            headers: {
                [name: string]: unknown;
            };
            content: {
                "application/json": components["schemas"]["GetWebBalancesByChainNameAndAddressResponse"];
            };
        };
...
export interface operations {
    ...
    GetWebStocksOips: {
        ...
        requestBody?: never;
        responses: {
            200: components["responses"]["GetWebStocksOipsSuccess"];
        };
    };
    ...
    GetWebStocksInfoDescription: {
        ...
        requestBody?: never;
        responses: {
            200: components["responses"]["GetWebStocksInfoDescriptionSuccess"];
        };
    };
    ...
    GetWebTokenInfoPageDescriptionByCoin: {
        parameters: {
            query?: never;
            header?: never;
            path: {
        ...
        requestBody?: never;
        responses: {
            200: components["responses"]["GetWebTokenInfoPageDescriptionSuccess"];
        };
    };
    ...
    GetWebBalancesByChainNameAndAddress: {
        parameters: {
            query?: {
                sparklines?: components["parameters"]["IncludeSparklines"];
                type?: components["parameters"]["AumAddressType"];
        ...
        requestBody?: never;
        responses: {
            200: components["responses"]["GetWebBalancesByChainNameAndAddressSuccess"];
        };
    };
