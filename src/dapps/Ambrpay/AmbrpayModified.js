        ...
        switch (account.netId) {
          case '1':
            ...
            if (ambrpay.network == 'mainnet' || ambrpay.network == 'auto') {
              ...
              throw 'your wallets network (mainnet) does not match the selected network for the transaction (' +
                ambrpay.network +
                ')';
            }
            break;
          ...
          case '3':
            if (ambrpay.network == 'ropsten' || ambrpay.network == 'auto') {
              ...
              throw 'your wallets network (ropsten) does not match the selected network for the transaction (' +
                ambrpay.network +
                ')';
            }
            break;
        ...
        .then(amount => {
          ...
          return new Promise(function(resolve, reject) {
            var instance = new _web3.eth.Contract(
              ambrpay.ABI.abi,
              '0x90678cba88eefb6da249f9221bf3444aeb2ad355'
            );
