    ...
    >
      ...
      <div class="mt-3">
        ...
        <ul class="textMedium--text">
          ...
          <li>
            For each new deposit into the pool, Stakewise mints an equal amount
            of sETH2 (1 ETH = 1 sETH2).
          </li>
          <li>
            Holders of sETH2 will start accruing rETH2 rewards within 24 hours
            of receiving the sETH2 token.
          </li>
