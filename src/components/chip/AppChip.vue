...
import { CHIP_VARIANT_BG_CLASS, type ChipVariant } from './types'
...
<template>
  <button
    ...
    data-testid="chip"
    class="inline-flex h-8 items-center rounded-full border px-1 text-s-14 font-medium text-t-default transition-colors duration-150 hover:bg-[#e6e6e6] active:bg-[#d6d6d6] focus-visible:border-primary focus-visible:outline-none disabled:pointer-events-none disabled:opacity-40"
    :class="[CHIP_VARIANT_BG_CLASS[variant], borderClass]"
