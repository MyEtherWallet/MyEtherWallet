  ...
  <teleport to="#app">
    ...
    >
      <div
        ...
        class="fixed z-[200] w-[360px] min-h-36 bg-white rounded-20 shadow-[0px_16px_36px_-6px_rgba(0,0,0,0.45)] p-4"
        :class="
          isAnchored
            ? 'origin-right'
      ...
      >
        ...
        <svg
          v-if="isAnchored"
          class="absolute top-1/2 -right-3.5 -translate-y-1/2 drop-shadow-[3px_2px_3px_rgba(0,0,0,0.28)]"
          width="14"
          height="20"
          viewBox="0 0 14 20"
          fill="none"
