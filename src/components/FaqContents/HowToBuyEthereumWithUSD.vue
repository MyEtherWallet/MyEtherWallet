<template>
  <div>
    <h5>Hello and welcome to Ethereum!</h5>
    <p>
      Ethereum and digital currencies are a pretty new world and in this new world,
      things can be a little bit different. First, you are responsible for your
      stuff. Your investments, your choices, your security. There are no babysitters
      or undo buttons or a bank to call up and reverse your transaction. The power
      of the blockchain is this, but it's also a dangerous thing if you are expecting
      to have all the cushy things you've come to enjoy.
    </p>
    <p>
      Secondly, most of the people involved in this world are pretty technical
      and sometimes forget how different things are. Take your time, ask questions,
      ask for clarification reach out for help, read the instructions, read the
      warnings, hang out, and try to learn new things.
    </p>
    <ul>
      <li>
        Scams and
        <a href="https://www.google.com/safebrowsing/static/faq.html#q1">phishing sites</a>
        and malicious links exist. Trust messages and random links about as much
        as those in your spambox. Verify verify verify.
      </li>
      <li>
        Always save &amp; back up your private key in a <em>separate</em>
    ...
    <h5>Still with me? Good! Let's dive deeper!</h5>
    <ul>
      <li>
        <a href="https://kb.myetherwallet.com/getting-started/whats-the-difference-between-an-exchange-and-myetherwallet.html">
          Understand the difference between a hosted wallet / exchange and
          client-side wallet before moving your ETH to your own wallet.
        </a>
      </li>
      <li>
      ...
      <li>
        <a href="https://kb.myetherwallet.com/getting-started/getting-back-to-basics-tips-for-newbies.html">
          10 Tips for Noobs
        </a>
        &amp;
        <a href="https://kb.myetherwallet.com/getting-started/ethereum-glossary.html">
          Words are Hard
        </a>
      ...
      <li>
        <a href="https://kb.myetherwallet.com/diving-deeper/">
          And even more links to awesome things just because
        </a>
      </li>
    </ul>

    <h5>Now, the fun part! How To Buy ETH</h5>
    <ol>
      <li>
        Create an account on Gemini or Coinbase or Kraken.
      </li>
      <li>
        Verify that account. You will need to upload a wide variety
        of documents proving you are who you say you are and stuff. It's all
        regulatory stuff. Once you upload this stuff, verification takes about a day
        or two (time is dependent on how busy the service is. During times of price
        increases and tons of new users, it may take longer. Be patient.)
      </li>
      <li>
        Follow the instructions on the exchange to deposit USD into that exchange.
        This, depending on your bank and the wire transfer, will typically
      ...
      <li>
        Once you have all the ETH you want, withdraw that ETH into a wallet that you
        control. Exchanges are notorious for being hacked (although the ones mentioned
        above are very reputable) and you want your funds in a place that you
        have the private key to. So...
      </li>
      <li>
        ...While you are waiting for your verification and transfer, download and install
        <a href="https://github.com/ethereum/mist/releases">Mist / Ethereum Wallet</a>.
        Run it so it can sync the blockchain.
      </li>
      <li>
        When you run it, it'll prompt you to make a new account. Create a password
        that you will never ever forget and create the account. Then, it'll give you
        an address that starts with 0x.. This what you will enter on your exchange to
        move your ETH from their account to your own.
      </li>
      <li>
