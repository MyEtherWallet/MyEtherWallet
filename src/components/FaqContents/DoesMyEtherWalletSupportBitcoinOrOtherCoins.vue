<template>
  <div>
    <h5>"Can I send Bitcoin or other coins (LTC STEEM ZEC) to MyEtherWallet?"*</h5>
    <p>We support <abbr>ETH</abbr>, <abbr>ETC</abbr>, <abbr>Testnet ETH</abbr>, <abbr>UBQ</abbr>, <abbr>EXP</abbr>, <abbr>RSK</abbr>, <abbr>MUSICOIN</abbr>, and any Ethereum Standard Tokens - aka "ERC-20" Tokens.</p>

    <p>
      You can use <a href="https://bity.com/">Bity.com</a> or <a href="http://shapeshift.io/">Shapeshift.io</a> or another exchange to swap / convert / exchange your other coins into ETH or Ethereum Tokens. However, you do not send those other coins directly to your Ethereum address.
    </p>

    <p>We recommend <a href="https://www.exodus.io/">Exodus.io</a> as a client-side, mutli-coin solution.</p>
