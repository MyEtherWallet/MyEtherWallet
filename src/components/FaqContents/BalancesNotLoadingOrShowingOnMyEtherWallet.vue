<template>
  <div>
    ...
    <code>ETC</code>
    <p>
      <a href="https://gastracker.io/">https://gastracker.io/</a>. Paste your address into the search bar and it will pull up your address and transaction history.
    </p>
    ...
    <ol>
      <li>
        Hard refresh the page. On Chrome on OSX you hit <abbr>cmd</abbr>+<abbr>shift</abbr>+<abbr>r</abbr>. On a PC, I assume it is <abbr>ctrl</abbr>+<abbr>shift</abbr>+<abbr>r</abbr>.
      </li>
      <li>
