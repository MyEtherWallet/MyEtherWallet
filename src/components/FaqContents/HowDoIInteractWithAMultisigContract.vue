<template>
  <div>
    ...
    <ol>
      <li>
        First, enter YOUR Contract Address in the
        <abbr>Contract Address</abbr> field at the top.
      </li>
      <li>
      ...
      <li>
        ...
        <ol>
          ...
          <li>
            Go back to XDC Wallet where you have the CONFIRM open and paste
    ...
    <h5>Mist / XDC Wallet's Multisig Contract ABI</h5>
    <p class="codes">
