      ...
      <v-sheet color="transparent" max-width="650px" class="mx-auto">
        ...
        <a href="https://www.mewwallet.com/" target="_blank">
          <mew-super-button
            ...
            class="mb-5"
            color-theme="basic"
            :title="$t('home.create-wallet.card-one.title')"
            :subtitle="$t('home.create-wallet.card-one.subtitle')"
        ...
        <mew-super-button
          ...
          class="mb-5"
          color-theme="basic"
          :title="$t('home.create-wallet.card-two.title')"
          :subtitle="$t('home.create-wallet.card-two.subtitle')"
          title-icon="mdi-shield-check"
          title-icon-type="mdi"
          title-icon-class="primary--text"
          right-icon-type="img"
        ...
        <mew-super-button
          ...
          class="mb-5"
          color-theme="outline"
          :title="$t('home.create-wallet.card-three.title')"
          :subtitle="$t('home.create-wallet.card-three.subtitle')"
          title-icon-class="warning--text text--darken-1"
          title-icon="mdi-alert"
          title-icon-type="mdi"
          :note="$t('home.create-wallet.card-three.note')"
