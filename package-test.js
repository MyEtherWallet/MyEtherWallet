...
const EXCEPTIONS = ['@makerdao/dai', '@myetherwallet/mewconnect-web-client', 'canvas', 'ethereum-ens', 'webpack', 'babel-jest', 'web3', 'web3-core-helpers', 'web3-core-method', 'web3-utils', '@xkeshi/vue-qrcode', 'multicoin-address-validator'];
const CUSTOM_DIST = {
  ['babel-core']: 'bridge'
};
