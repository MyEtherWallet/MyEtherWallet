...
const EXCEPTIONS = ['@myetherwallet/mewconnect-web-client', 'multicoin-address-validator', 'canvas', 'ethereum-ens', 'webpack', 'babel-jest', 'web3', 'web3-core-helpers', 'web3-core-method', 'web3-utils', '@xkeshi/vue-qrcode'];
const CUSTOM_DIST = {
  ['babel-core']: 'bridge'
};
