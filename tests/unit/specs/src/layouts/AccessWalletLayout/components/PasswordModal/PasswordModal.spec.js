...
describe('PasswordModal.vue', () => {
    ...
    xit('[FAILING MAX STACK] should render password data', () => {
        const password='password';
        wrapper.setData({password})
        expect(wrapper.vm.$el.querySelector('.password-form input').value).toEqual(password);
    });

    xit('[FAILING MAX STACK] should render error data', () => {
        const error='error';
    ...
    describe('PasswordModal.vue Methods', () => {
        xit('[FAILING MAX STACK] should switch view password when image button clicked', () => {
