...
describe('SwapSendToModal.vue', () => {
   let localVue, i18n, wrapper, store;
    ...
    it('should render correct fromAddress data', () => {
      ...
      expect(wrapper.vm.$el.querySelector('.from-address .address').textContent.trim()).toEqual(wrapper.vm.$data.fromAddress.address);
    });
    ...
    it('should render correct toAddress data', () => {
      ...
      expect(wrapper.vm.$el.querySelector('.to-address .address').textContent.trim()).toEqual(wrapper.vm.$data.toAddress.address);
    });
