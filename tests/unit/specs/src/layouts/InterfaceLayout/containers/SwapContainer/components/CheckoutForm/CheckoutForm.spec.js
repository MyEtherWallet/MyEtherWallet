...
describe('CheckoutForm.vue', () => {
  ...
  it('should render correct formData version', () => {
    ...
    expect(wrapper.vm.$el.querySelectorAll('#payment_form input')[0].value).toEqual(formData.version);
  });
  ...
  it('should render correct formData partner', () => {
    ...
    wrapper.setProps({ formData });
    expect(wrapper.vm.$el.querySelectorAll('#payment_form input')[1].value).toEqual(formData.partner);
  });
  ...
  it('should render correct formData return_url', () => {
    ...
    wrapper.setProps({ formData });
    expect(wrapper.vm.$el.querySelectorAll('#payment_form input')[3].value).toEqual(formData.return_url);
  });
  ...
  it('should render correct formData quote_id', () => {
    ...
    wrapper.setProps({ formData });
    expect(wrapper.vm.$el.querySelectorAll('#payment_form input')[4].value).toEqual(formData.quote_id);
  });
  ...
  it('should render correct formData payment_id', () => {
    ...
    wrapper.setProps({ formData });
    expect(wrapper.vm.$el.querySelectorAll('#payment_form input')[5].value).toEqual(formData.payment_id);
  });
  ...
  it('should render correct formData user_id', () => {
    ...
    wrapper.setProps({ formData });
    expect(wrapper.vm.$el.querySelectorAll('#payment_form input')[6].value).toEqual(formData.user_id);
  });
  ...
  it('should render correct formData destination_wallet_address', () => {
    ...
    wrapper.setProps({ formData });
    expect(wrapper.vm.$el.querySelectorAll('#payment_form input')[7].value).toEqual(formData.destination_wallet_address);
  });
  ...
  it('should render correct formData destination_wallet_currency', () => {
    ...
    wrapper.setProps({ formData });
    expect(wrapper.vm.$el.querySelectorAll('#payment_form input')[8].value).toEqual(formData.destination_wallet_currency);
  });
  ...
  it('should render correct formData fiat_total_amount_amount', () => {
    ...
    wrapper.setProps({ formData });
    expect(wrapper.vm.$el.querySelectorAll('#payment_form input')[9].value).toEqual(formData.fiat_total_amount_amount);
  });
  ...
  it('should render correct formData fiat_total_amount_currency', () => {
    ...
    wrapper.setProps({ formData });
    expect(wrapper.vm.$el.querySelectorAll('#payment_form input')[10].value).toEqual(formData.fiat_total_amount_currency);
  });
  ...
  it('should render correct formData digital_total_amount_amount', () => {
    ...
    wrapper.setProps({ formData });
    expect(wrapper.vm.$el.querySelectorAll('#payment_form input')[11].value).toEqual(formData.digital_total_amount_amount);
  });
  ...
  it('should render correct formData digital_total_amount_currency', () => {
    ...
    wrapper.setProps({ formData });
    expect(wrapper.vm.$el.querySelectorAll('#payment_form input')[12].value).toEqual(formData.digital_total_amount_currency);
  });
