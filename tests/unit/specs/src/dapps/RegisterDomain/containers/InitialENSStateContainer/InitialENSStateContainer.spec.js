...
describe('InitialENSStateContainer.vue', () => {
    ...
    xit('[FAILING] should render correct input element classname according to domainname', () => {
    ...
    xit('[FAILING] should render correct submit button element classname according to domainname', () => {
    ...
    xit('[FAILING] should show/hide erroredMsg p element according to domain name', () => {
