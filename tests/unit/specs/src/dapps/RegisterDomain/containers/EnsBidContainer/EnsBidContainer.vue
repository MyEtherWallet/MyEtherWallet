    ...
    <div class="name-available-container">
      ...
      <div role="tablist">
        <b-card-header
          ...
          header-tag="header"
        >
          <div><span> 1 </span> &nbsp; Bid Information</div>
          <div v-show="showDetail" class="edit" @click="editInputs">Edit</div>
        </b-card-header>
        <b-collapse
          id="bidAccordion"
          v-model="showInfo"
          ...
          <div class="inputs-container">
            ...
            <div class="input-container">
              ...
              <p v-show="localBidAmount >= localBidMask" class="erroredMsg">
                We recommend having your Bid mask higher than your Bid amount.
              </p>
            </div>
            <div class="input-container">
              <label for="localSecretPhrase" class="secret-phrase-label">
                ...
                <span class="random" @click.prevent="generateKeyPhrase">
                  <i class="fa fa-lg fa-refresh" /> Random
                </span>
              </label>
              <input
        ...
        >
          <div class="inputs-container">
            <div class="confirmation-warning">
              You CAN NOT claim your name unless you have this information
              during the reveal process. We suggest that you have to save those
              information.
            </div>
