...
describe('partners', () => {
  ...
  xit('should return rates for all but simplex', async done => {
  ...
  xit('should return rates for bity and changelly', async done => {
  ...
  xit('should return rates only from simplex', async done => {
