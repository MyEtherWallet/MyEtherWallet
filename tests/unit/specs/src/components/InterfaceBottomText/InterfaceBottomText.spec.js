...
describe('InterfaceBottomText.vue', () => {
  it('should render correct contents', () => {
    ...
    expect(vm.$el.querySelector('div p').textContent.trim())
      .toEqual('question linkText')
    expect(vm.$el.querySelector('div p a').textContent.trim())
      .toEqual('linkText')
    expect(vm.$el.querySelector('div p a').getAttribute('href'))
      .toEqual('link')
  })
