 ...
 * `common.perps`/`common.perpetuals` (the perps nav labels) were localized as
 * part of MEW-2012 and are no longer drift. Logged in workspace FOLLOWUPS.md.
 * Excluded from BOTH sides of the parity comparison so the guard asserts THIS
 * branch introduced no new drift, in either direction.
 */
